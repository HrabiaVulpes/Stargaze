...
public class Connection {
    ...
    public PlaceEnum.Place whereIsSystem(StarSystem testedSystem){
        if(testedSystem.getY() == this.a * testedSystem.getX() + this.b)
            return  PlaceEnum.Place.ON_CONNECTION;
        else if (testedSystem.getY() > this.a * testedSystem.getX() + this.b)
            return PlaceEnum.Place.OVER_CONNECTION;
        else return PlaceEnum.Place.ON_CONNECTION;
    }
